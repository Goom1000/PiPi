...
const ExportModal: React.FC<ExportModalProps> = ({
  ...
  const handleExport = () => {
    ...
    // AI Poster mode not yet implemented
  };

  // Get button text
  const getExportButtonText = () => {
    if (isGenerating && generationProgress) {
      return `Generating... ${generationProgress.current}/${generationProgress.total}`;
    }
        ...
        <div className="bg-white dark:bg-slate-900 w-full max-w-4xl max-h-[90vh] rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden flex flex-col">
          ...
          <div className="px-6 pt-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              {/* AI Poster (Coming Soon) */}
              <div className="relative">
                <button
                  disabled
                  className="w-full p-4 rounded-xl border-2 text-left border-slate-200 dark:border-slate-700 opacity-60 cursor-not-allowed"
                >
                  <div className="flex items-center gap-2 mb-2">
                ...
                <span className="absolute top-2 right-2 px-2 py-0.5 bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 text-[10px] font-bold uppercase rounded-full">
                  Coming Soon
                </span>
              </div>
            </div>
